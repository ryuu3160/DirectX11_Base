...
private:
	...
	void UpdateFadeIn(_Inout_ FadeInfo &InOut_FadeInfo, _In_ float In_DeltaTime) noexcept;
	void UpdateFadeOut(_Inout_ FadeInfo &InOut_FadeInfo, _In_ float In_DeltaTime) noexcept;
