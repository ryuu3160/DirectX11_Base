/*+===================================================================
	File: RTSpriteRenderer.hpp
	Summary: レンダーターゲットのスプライトレンダラー
	Author: AT13C192 01 青木雄一郎
	Date: 2025/11/13 Thu AM 10:41:02 初回作成
===================================================================+*/
#pragma once
...
public:
	...
	void SetRenderContext(_In_ RenderContext *In_Context) noexcept;
...
private:
	SpriteRenderer::SpriteData m_SpriteData;				// スプライトデータ
